            ...
            <View style={styles.stack}>
                    ...
                    <View style={styles.imageForeground}>
                        <Svg height="170" width="170" viewBox="0 0 170 170">
                            ...
                            <Image href={{ uri: url}}   clipPath="#clipImg" />
                        </Svg>
                    </View>
